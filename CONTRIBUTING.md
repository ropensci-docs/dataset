...
package and are listed in `.Rbuildignore`, such as the `docs/` folder
contents, which contains the package website’s html and Javascript data.
...
documented with `roxygen2` notation; see [Chapter 8: Object
documentation](https://bookdown.dongzhuoer.com/hadley/r-pkgs/man.html)
in [R Packages (2e)](https://r-pkgs.org/). Code should conform to our
[rOpenSci Style
...
[AppVeyor](https://ci.appveyor.com/project/dataobservatory-eu/dataset)
...
Please note that the creation of the `dataset` package as a project is
released with a [Contributor Code of
Conduct](https://docs.ropensci.org/dataset/CODE_OF_CONDUCT.md). By
